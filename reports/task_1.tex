...
\begin{document}
    ...
    \section{Transkoder czterobitowych cyfr szesnastkowych na wyświetlacz siedmiosegmentowy}
        \subsection{Minimalizacja funkcji boolowskich}
            ...
            \begin{center}
                \includegraphics[height=9cm]{reports/img/Z1A_table_1.png}\\
            \end{center}
            ...
            \begin{center}
                \includegraphics[height=9cm]{reports/img/Z1A_table_3.png}\\
            \end{center}
            % \begin{center}
            %     \begin{table}[ht]
            %         \centering
            ...
            \begin{center}
                \includegraphics[height=9cm]{reports/img/Z1A_table_4.png}\\
            \end{center}
            % \begin{center}
            %     \begin{table}[ht]
            %         \centering
            ...
            \begin{center}
                \includegraphics[height=9cm]{reports/img/Z1A_table_5.png}\\
            \end{center}
            % \begin{center}
            %     \begin{table}[ht]
            %         \centering
            ...
            \begin{center}
                \includegraphics[height=9cm]{reports/img/Z1A_table_6.png}\\
            \end{center}
            % \begin{center}
            %     \begin{table}[ht]
            %         \centering
            ...
            \begin{center}
                \includegraphics[height=9cm]{reports/img/Z1A_table_7.png}\\
            \end{center}
            % \begin{center}
            %     \begin{table}[ht]
            %         \centering
            ...
            \begin{center}
                \includegraphics[height=9cm]{reports/img/Z1A_table_8.png}\\
            \end{center}
            % \begin{center}
            %     \begin{table}[ht]
            %         \centering
